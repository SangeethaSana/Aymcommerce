package com.pg.clubpampers.eurbu.android.uat.bdd.report.listener;
...
import com.pg.clubpampers.eurbu.android.uat.log.listener.RuntimeLoggerListner;
...
public class ReportRuntimeListener implements ReportListener {
	...
	public ExtentReports reportEngine() {
		...
		ReportPath = Paths.get("").toAbsolutePath() + "/test-output/AYM-Dashboard.html";
